        ...
        <div className="single-product-info">
          <header>
            ...
            <ul className="basic-info">
              ...
              <li className="lists">
                {" "}
                <BiIcons.BiStar className="rating-start" /> {isProduct?.rating}
                /5
              </li>
            ...
            <h1 className="card-price product-price">
              {" "}
              ₹ {isProduct?.currentPrice}{" "}
              <span className="discount-price">
                ₹ {priceFormatter(isProduct?.originalPrice)}/-
              </span>
            </h1>
          ...
          <div className="card-footer">
            {cart?.find((eachProduct) => eachProduct._id === isProduct._id) ? (
              <button
              ...
              <button
                className="btn btn-primary btn-move-cart text-sm center"
                onClick={() =>
                  token ? addToCart(isProduct) : navigate("/login ")
                }
              >
                Add to cart
              </button>
          ...
          wishlist.find((eachItem) => eachItem._id === isProduct._id) ? (
            ...
            <button
              ...
              disabled={loading}
              onClick={() =>
                token ? addToWishlist(isProduct) : navigate("/login")
              }
            >
              <FaIcons.FaHeart className="wishlist-icon" />
            </button>
